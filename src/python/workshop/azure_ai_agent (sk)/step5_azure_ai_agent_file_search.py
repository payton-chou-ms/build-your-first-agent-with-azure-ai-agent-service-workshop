...
"""
以下範例示範如何建立一個簡單的 Azure AI agent，
該 agent 使用檔案搜尋工具來回覆使用者問題。
"""
...
async def main() -> None:
    ...
    async with (
        ...
        pdf_file_path = os.path.join(
            os.path.dirname(os.path.dirname(os.path.realpath(__file__))), "./azure_ai_agent/resources", "employees.pdf"
        )
