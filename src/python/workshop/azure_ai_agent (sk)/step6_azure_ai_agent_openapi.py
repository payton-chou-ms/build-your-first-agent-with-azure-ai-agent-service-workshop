...
async def main() -> None:
    ...
    async with (
        ...
        with open(os.path.join(openapi_spec_file_path, "../azure_ai_agent/resources/weather.json")) as weather_file:
            weather_openapi_spec = json.loads(weather_file.read())
        with open(os.path.join(openapi_spec_file_path, "../azure_ai_agent/resources/countries.json")) as countries_file:
