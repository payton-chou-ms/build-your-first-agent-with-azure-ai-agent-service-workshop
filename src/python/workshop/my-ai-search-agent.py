...
AGENT_NAME = f"AI Search Agent {random_suffix}"
PROJECT_DATA_SHEET_FILE = "datasheet/project-requirement.md"
...
INSTRUCTIONS_FILE = "instructions/ai_search.txt"
